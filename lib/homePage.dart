...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    final List<String> imageList = ['https://images.unsplash.com/photo-1542362567-b07e54358753?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
            ...
            SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 30,),
                    Text("CARRUS – Trusted Car Rental Services ",style: TextStyle(fontWeight: FontWeight.w800,fontSize: 20),),
                    SizedBox(height: 15,),
                    Text("CARRUS is one of the most trusted car rental services as it is promoted by TATA Motors. The rent-a-car service provider offers an outstanding model and a wide variety of vehicle options at the most competitive rates. With CARRUS’s commitment to providing a hassle-free service, you will have the best rent-a-car experience. This means that you can carry out all your plans without any hamper. At CARRUS, we provide cars that can meet your every need. Also, we allow you to enjoy flexibility with respect to start and endpoints. You can book cars on an hourly, daily, or weekly basis without any security deposit. We provide door-step delivery and we believe in complete transparency and adhere strictly to business ethics. This means that you need not worry about any hidden charges when renting cars from us.",style: TextStyle(fontStyle: FontStyle.italic,),textAlign: TextAlign.center,),
                    SizedBox(height: 20,),
                    TextButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Booking()));}, child: Text("Book Car"))
                  ],
                )
            ),
          );
